...
| Проверка гипотез по увеличению выручки  | *Исследование направлено* на проверку гипотез и оценку результатов A/B теста.| Python, Pandas, Numpy, Seaborn, Matplotlib, SciPy, A/B-тестирование, проверка статистических гипотез| [Принятие решений в бизнесе][7] |
